...
var (
	...
	// FtsExternalJobsColumns holds the columns for the "fts_external_jobs" table.
	FtsExternalJobsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "datetime"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "datetime"}},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "datetime"}},
		...
		{Name: "snapshot_token", Type: field.TypeString},
		{Name: "mode", Type: field.TypeString, Default: ""},
		{Name: "trigger_reason", Type: field.TypeString, Default: ""},
		{Name: "attempt", Type: field.TypeInt, Default: 1},
		{Name: "result_payload", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "error_payload", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "manifest_path", Type: field.TypeString, Nullable: true},
		{Name: "quality_report", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "requested_at", Type: field.TypeTime},
		{Name: "deadline_at", Type: field.TypeTime},
		{Name: "completed_at", Type: field.TypeTime, Nullable: true},
	}
	// FtsExternalJobsTable holds the schema information for the "fts_external_jobs" table.
	FtsExternalJobsTable = &schema.Table{
		Name:       "fts_external_jobs",
		Columns:    FtsExternalJobsColumns,
		PrimaryKey: []*schema.Column{FtsExternalJobsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "ftsexternaljob_file_id_entity_id",
				Unique:  false,
				Columns: []*schema.Column{FtsExternalJobsColumns[6], FtsExternalJobsColumns[8]},
			},
			{
				Name:    "ftsexternaljob_status_deadline_at",
				Unique:  false,
				Columns: []*schema.Column{FtsExternalJobsColumns[5], FtsExternalJobsColumns[18]},
			},
		},
	}
